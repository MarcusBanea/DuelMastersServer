...
import com.duelmasters.DuelMastersServer.Domain.AbilityExecution.Abilities;
...
import com.duelmasters.DuelMastersServer.Service.AI.AIAction;
import com.duelmasters.DuelMastersServer.Service.AI.AIEngine;
...
@Data
//@Scope("singleton")
public class PlayerVsPlayerEngine implements GameEngine {
	...
	private static boolean canCardBeAttacked(GameCardDTO attackingCard, GameCardDTO attackedCard) {
...
//				}
	...
	public class AIState {
		...
		public ArrayList<AIMove> makeRandomAction() {
			...
			while(possibleActionsThisTurn.size() != 0) {
